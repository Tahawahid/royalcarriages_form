...
<section class="mx-auto max-w-2xl px-6 py-24 text-center">
    <div class="space-y-6">
        <div class="space-y-3">
            <h1 class="text-6xl font-bold text-slate-900">300</h1>
            <h2 class="text-2xl font-semibold text-slate-700">Multiple Choices</h2>
            <p class="text-lg text-slate-600">
                There are multiple options available. Please choose one.
            </p>
        </div>
