    ...
    <section class="mx-auto max-w-6xl px-6 py-12 md:py-16">
        <div class="space-y-6">
            ...
            <div class="rounded-2xl bg-white/95 p-6 shadow-lg shadow-amber-100 ring-1 ring-slate-100"
                ...
                <div class="space-y-8">
                    @foreach (['one-way' => 'One Way Reservation', 'round-trip' => 'Round Trip Reservation', 'hourly' => 'Hourly Reservation'] as $key => $title)
                        <form class="reservation-form {{ $loop->first ? '' : 'hidden' }} space-y-6" data-form="{{ $key }}" action="{{ route('reservations.store') }}" method="POST">
                            ...
                            <div class="flex items-center justify-between rounded-xl bg-slate-50 px-4 py-3">
                                <p class="text-sm font-semibold text-slate-900">Secure reservation</p>
