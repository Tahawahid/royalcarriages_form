                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-3 rounded-2xl bg-amber-50 px-6 py-6 ring-1 ring-amber-200">
                        ...
                        <p class="text-base text-slate-700 md:text-lg">
                            ...
                            <span class="font-semibold text-slate-900">+1 (713) 266-5466</span>. The International callers can
                            contact at the same number <span class="font-semibold text-slate-900">+1 (713) 266-5466</span>. For
                            more enquiries, email us at <span class="font-semibold text-slate-900">info@bestlimousines.com</span>.
                        </p>
