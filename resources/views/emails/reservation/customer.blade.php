...
<head>
    ...
    <title>Reservation Confirmation - Royal Carriages</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">Dear {{ $data['first_name'] }},</div>
            <p style="color: #4b5563; line-height: 1.6; margin-bottom: 20px;">Thank you for choosing Royal Carriages Limousines! Your {{ ucwords(str_replace('-', ' ', $data['reservation_type'] ?? 'reservation')) }} has been confirmed. We look forward to providing you with exceptional luxury transportation service.</p>
            ...
            <div class="important-info">
                ...
                <ul style="color: #065f46; margin: 0; padding-left: 20px; font-size: 13px;">
                    ...
                    @if(isset($data['return_pickup_date']))
                    <li>For round trip service, please be ready for return pickup as scheduled</li>
                    @endif
                </ul>
            </div>
