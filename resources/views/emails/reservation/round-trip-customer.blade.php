...
<head>
    ...
    <style>
        ...
        .return-card { background: #fef3e2; border-radius: 12px; padding: 25px; border-left: 4px solid #f59e0b; margin-top: 20px; }
        .trip-divider { height: 3px; background: linear-gradient(to right, #3b82f6, #60a5fa); margin: 20px 0 10px; border-radius: 2px; }
        ...
        <div class="container">
            <div class="header">
                <div class="logo-section">
                    ...
                    <h2 class="header-title">Round-Trip Reservation Received!</h2>
            ...
            <div class="content">
                ...
                <p class="intro-text">
                    Thank you for choosing Best Limousines! We have received your round-trip reservation request and our team will review your requirements and <span class="highlight-text">confirm your booking within 24 hours</span>. We're excited to help make your transportation experience exceptional!
                </p>
                ...
                <div class="schedule-section">
                    <div class="section-title">
                        <span class="section-icon">📅</span> Outbound Trip Schedule
                    </div>
                    <div class="trip-card">
                        <div class="detail-grid">
                            <div class="detail-item">
                    ...
                    <div class="section-title">
                        <span class="section-icon">📅</span> Return Trip Schedule
                    </div>
                    <div class="return-card">
                        <div class="detail-grid">
                            <div class="detail-item">
                                <div class="detail-label">Return Date:</div>
                                <div class="detail-value">{{ isset($data['return_date']) ? date('l, F j, Y', strtotime($data['return_date'])) : 'N/A' }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Pick-up Time:</div>
                                <div class="detail-value">{{ isset($data['return_time']) ? date('g:i A', strtotime($data['return_time'])) : 'N/A' }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Pick-up Location:</div>
                                <div class="detail-value">{{ $data['dropoff_location'] ?? 'N/A' }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Drop-off Location:</div>
                                <div class="detail-value">{{ $data['pickup_location'] ?? 'N/A' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="next-steps">
                    ...
                    <ul class="steps-list">
                        <li><strong>Review:</strong> Our team will review both legs of your round-trip reservation</li>
                        <li><strong>Confirmation:</strong> We'll confirm your booking and send final details within 24 hours</li>
                        <li><strong>Driver Assignment:</strong> Professional chauffeurs will be assigned to both trips</li>
                ...
                <div class="closing-section">
                    ...
                    <p class="priority-text">Your round-trip reservation is our priority.</p>
                </div>
            </div>
