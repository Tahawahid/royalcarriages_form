        ...
        <div class="container">
            <div class="header">
                <div class="logo-section">
                    ...
                    <h2 class="header-title">Hourly Service Confirmed!</h2>
                    <div class="status-confirmed">✓ HOURLY SERVICE CONFIRMED</div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <p class="intro-text">
                    Your hourly luxury transportation is confirmed! Please save this confirmation for your records. We look forward to providing you with exceptional service.
                </p>
                ...
                <div class="section">
                    ...
                    <div class="detail-card">
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                <div class="detail-label">Hours of Service:</div>
                                <div class="detail-value">{{ $data['hours_of_service'] ?? 'Not specified' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">Hourly Service Confirmed</p>
        </div>
        
        <div class="content">
            <div class="greeting">Hi {{ $data['first_name'] }},</div>
            <div class="status-confirmed">✓ HOURLY SERVICE CONFIRMED</div>
            <p class="intro-text">Your hourly luxury transportation is confirmed! Please save this confirmation for your records. We look forward to providing you with exceptional service.</p>
