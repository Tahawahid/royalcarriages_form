...
<head>
    ...
    <title>Hourly Reservation Confirmation - Royal Carriages</title>
    <style>
        ...
        <div class="container">
            <div class="header">
                <div class="logo-section">
                    ...
                    <div class="status-confirmed">Hourly Reservation</div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <p class="intro-text">
                    Thank you for choosing Royal Carriages. We have received your hourly reservation request and will review it shortly. A team member will reach out within 24 hours to confirm your booking and finalize payment.
                </p>
                    ...
                    <div class="detail-card">
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ $data['company'] ?? 'N/A' }}</div>
                            </div>
                            <div class="detail-item">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ $data['billing_address'] ?? 'Not specified' }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Billing City</div>
                                <div class="detail-value">{{ $data['billing_city'] ?? 'Not specified' }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Billing State</div>
                                <div class="detail-value">{{ $data['billing_state'] ?? 'Not specified' }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Billing ZIP</div>
                                <div class="detail-value">{{ $data['billing_zip'] ?? 'Not specified' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="next-steps">
                    ...
                    <ul class="steps-list">
                        ...
                        <li>We will contact you within 24 hours to confirm everything.</li>
