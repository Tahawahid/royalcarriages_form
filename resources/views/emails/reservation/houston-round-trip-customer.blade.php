        ...
        <div class="container">
            <div class="header">
                <div class="logo-section">
                    ...
                    <p class="header-message">We'll confirm both legs of your journey within 24 hours 🚗</p>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <p class="intro-text">
                    Thank you for your interest in Limo Service In Houston! We have received your round-trip reservation request and our team will review your requirements and <span class="highlight-text">confirm both legs of your journey within 24 hours</span>. We're excited to provide you with exceptional transportation service!
                </p>
                
                <div class="schedule-section">
                    <div class="section-title">
                        <span class="section-icon">📅</span> Outbound Trip - Schedule and Location
                    </div>
                    <div class="trip-card">
                    ...
                    <div class="return-card">
                        <div class="detail-grid">
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ date('l, F j, Y', strtotime($data['return_pickup_date'])) }}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Return Pick-up Time:</div>
                            ...
                            <div class="detail-item">
                                <div class="detail-label">Return Pick-up Location:</div>
                ...
                <div class="next-steps">
                    ...
                    <ul class="steps-list">
                        <li><strong>Review:</strong> Our team will review your reservation details and vehicle availability for both legs</li>
                        <li><strong>Confirmation:</strong> A reservation specialist will contact you within 24 hours to confirm times and locations</li>
