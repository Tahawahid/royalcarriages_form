        ...
        <div class="container">
            <div class="header">
                <div class="logo-section">
                    ...
                    <h2 class="header-title">One-Way Reservation Confirmed!</h2>
            ...
            <div class="content">
                ...
                <p class="intro-text">
                    Your one-way luxury transportation is confirmed! Please save this confirmation for your records. We look forward to providing you with exceptional service.
                </p>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">One-Way Reservation Confirmed</p>
        </div>
        
        <div class="content">
            <div class="greeting">Hi {{ $data['first_name'] }},</div>
            <div class="status-confirmed">✓ ONE-WAY TRIP CONFIRMED</div>
            <p class="intro-text">Your one-way luxury transportation is confirmed! Please save this confirmation for your records. We look forward to providing you with exceptional service.</p>
