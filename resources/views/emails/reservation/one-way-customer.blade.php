...
<head>
    ...
    <title>One-Way Reservation Confirmation - Best Limousines</title>
    <style>
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="alert-banner">
                    <p class="alert-text">Thank you for choosing Best Limousines. We are reviewing your one-way request and will confirm your trip within 24 hours.</p>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="next-steps-card">
                        <ul class="steps-list">
                            ...
                            <li>A reservation specialist will contact you within 24 hours to confirm your trip.</li>
                ...
                <div class="closing-note">
                    <span class="closing-strong">Thank you for trusting Best Limousines.</span> We are excited to provide a smooth, punctual, and comfortable experience for your upcoming ride.
                </div>
            </div>
