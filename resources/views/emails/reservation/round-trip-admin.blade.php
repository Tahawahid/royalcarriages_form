...
<head>
    ...
    <title>Round-Trip Reservation - Royal Carriages</title>
    <style>
        ...
        .trip-divider { background: #3b82f6; height: 2px; margin: 25px 0 15px; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin: 8px 0 0 0; opacity: 0.9;">New Round-Trip Reservation</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="section-header">🚜 Return Trip</div>
            <div class="info-row">
                <div class="label">Return Date:</div>
                <div class="value">{{ date('m/d/Y', strtotime($data['return_pickup_date'])) }}</div>
            </div>
            <div class="info-row">
                <div class="label">Return Time:</div>
                <div class="value">{{ date('g:i A', strtotime($data['return_pickup_time'])) }}</div>
            </div>
            <div class="info-row">
                <div class="label">Return Route:</div>
