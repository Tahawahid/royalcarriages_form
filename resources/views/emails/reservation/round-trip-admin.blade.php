...
<head>
    ...
    <title>New Round-Trip Reservation - Royal Carriages</title>
    <style>
        ...
        .trip-divider { height: 3px; background: linear-gradient(to right, #3b82f6, #60a5fa); margin: 30px 0 20px; border-radius: 2px; }
        ...
        .return-card { background: #fef3e2; border-radius: 10px; padding: 20px; border-left: 4px solid #f59e0b; }
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="alert-banner">
                    <p class="alert-text">⚡ New round-trip reservation received - Both legs confirmed</p>
                </div>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">New Round-Trip Reservation</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="trip-section">
                ...
                @if($data['return_other_requirements'] ?? false)
                <div class="info-item full-width" style="background: white; margin-top: 10px;">
                    <div class="label">Return Trip Requirements</div>
                    <div class="value">{{ $data['return_other_requirements'] }}</div>
                </div>
                @endif
            </div>
